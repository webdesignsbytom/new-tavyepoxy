...
export const galleryDataArray = [
  ...
  },
  {
    ...
    name: 'Red Passion',
    shortDesc:
      'Made from old 120 year old reclaimed oak and using vibrant reds and whites to create contrast with eah other. On a black base that blends naturally together using gravity to create the unique swirls.',
