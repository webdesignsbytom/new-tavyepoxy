...
export const galleryDataArray = [
  {
    ...
    url: 'table_1',
    name: 'Wood Striation',
    data: 'Indulge in the extraordinary with our meticulously handcrafted Epoxy Resin Coffee Table – a masterpiece where nature\'s artistry intertwines with contemporary design. Imagine a coffee table that captures the timeless beauty of natural wood, adorned with a vibrant palette of solid and metallic colors. It\'s not just furniture; it\'s a work of art. Unique Elegance: Each of our epoxy resin coffee tables is a singular creation, a testament to the artistry of our skilled craftsmen. No two tables are alike, ensuring that you\'ll own a truly one-of-a-kind piece that stands as a conversation starter in any room. Affordable Luxury: We believe in making luxury accessible. Our stunning epoxy resin coffee table offers unparalleled elegance without breaking the bank. It\'s a statement piece that doesn\'t come with a designer price tag, making it the perfect addition to your home. Crafted to Perfection: Handmade and expertly crafted in the heart of Devon, each table undergoes a labor-intensive process that involves pouring, shaping, and polishing. The result? A glass-smooth epoxy tabletop with a mesmerizing pattern that seamlessly flows over the edges, creating an illusion of a wooden masterpiece. Endless Possibilities: Whether your décor leans toward modern, rustic, or eclectic, this coffee table effortlessly adapts to your style. Its versatility is matched only by its durability, promising years of enjoyment. Elevate your living space with a piece of art that also serves your coffee. Bring home our Epoxy Resin Coffee Table and experience the fusion of natural beauty and contemporary design today.',
