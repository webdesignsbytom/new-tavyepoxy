...
export const AvailableItemsArray = [
  ...
  // }
  {
    ...
    shipping: 24,
    onSale: false,
    shortDesc: 'Using a beautiful style of blending thin lines to mimic the appearance of wood striations. Using naturally found colours and a blend of metallics to bring the colours to life. The stripes can be shaped to anything thickness to suit taste.',
  ...
  },
  {
    ...
    shipping: 24,
    onSale: false,
    shortDesc: 'Made to look like a beautiful and unique stone effect. Using natural stone and metallic colours and allowed to flow together using gravity and air pressure to create a gorgeous effect. This looks like rock cut from a quarry.',
    desc: "Introducing our extraordinary Epoxy Resin Coffee Table with a Stone Effect – a testament to the beauty of nature's artistry, meticulously crafted to bring the elegance of exotic stone right into your living space. Dive into the intricate layers of detail, where natural metallics and earthy colors mingle to create a masterpiece that will become the focal point of any room.<br /><strong>Stone-Inspired Elegance:</strong> Our coffee table is a harmonious blend of art and nature, with colors inspired by the rich tones of bronze, copper, metallic blacks, and silver. Each layer is carefully mixed to mimic the breathtaking beauty of naturally sliced exotic stone, ensuring that your table is a unique work of art.<br /><strong className='mt-8'>Affordable Opulence:</strong> We believe that luxury should be within reach. Our stunning epoxy resin coffee table offers unparalleled opulence without the premium price tag. It's a statement piece that embodies luxury and affordability, making it the perfect centerpiece for your home.<br /><strong>Crafted to Perfection:</strong> Handmade and expertly crafted in Devon, each table undergoes a meticulous process that involves pouring, shaping, and polishing. The result? A glass-smooth epoxy tabletop with a mesmerizing stone-like pattern that seamlessly flows over the edges, creating an illusion of a genuine stone slice.<br /><strong>Versatile Beauty:</strong> Whether your decor is modern, rustic, or eclectic, this coffee table effortlessly complements your style. Its versatility matches its durability, promising years of admiration and enjoyment.<br />Elevate your living space with a piece of art that mirrors the splendor of nature's most exotic stones. Bring home our Epoxy Resin Coffee Table with a Stone Effect and experience the timeless beauty of nature in the heart of your home.",
    pageData: {
      videoLinks: STxVideo,
      subtitle: 'Stone and natural metallics',
      undercoat: 'Black',
      timber: 'MDF',
      legs: 'Metal pin legs',
      height: '30cm',
  ...
  },
  {
    ...
    shipping: 24,
    onSale: true,
    shortDesc: 'Ocean and sky blues combined and blended with darker accent colours to create beautiful and unique patterns that you can stare at for hours.',
    ...
    pageData: {
      videoLinks: OSxVideo,
      subtitle: 'Ocean and sky blues and spray',
      undercoat: 'Black',
      timber: 'MDF',
      legs: 'Metal pin legs',
      height: '30cm',
